    ...
    $("#btnAddOrUpdateUsers").click(function (event) {
        ...
        if ($('#userId').val() != "") {
            ...
            if (roleCode != '') {
                ...
                window.location.href = "<c:url value='/admin/customer-edit-"+userId+"?message=role_require'/>";
            }
        }
        else {
            ...
            if (userName != '' && roleCode != '') {
                ...
                window.location.href = "<c:url value='/admin/customer-edit?message=username_role_require'/>";
            }
        }
    });
